...
const MyStack = useNavigation();
  ...
  const onRegisterPressed = () => {
    ...
    //
      ...
      alert("please enter Currentcompany")
      return true
    }
    ...
    else if(Previouscompany1 == "") {
      alert("please enter Previouscompany1")
      return true
    }
    ...
    else if(Previouscompany2 == "") {
      alert("please enter Previouscompany2")
      return true
    }
...
{/*   Professional Detail  */}
<Text style={{fontSize: 25,fontWeight:'bold',color: 'gray', padding: 20}}>Professional Details</Text>
      <Text style={{fontSize: 25,fontWeight:'bold',color: 'gray', padding: 20}}>Currentcompany</Text>
      <Text></Text>
      <Text style={{fontSize: 25,color: 'lightblue',fontStyle: 'italic'}}>Starting Date</Text>
      {/* Display the selected date */}
      <View style={styles.pickedDateContainer}>
        <Text style={styles.pickedDate}>{date1.toUTCString()}</Text>
      </View>

      {/* The button that used to trigger the date picker */}
      {!isPickerShow1 && (
        <View style={styles.btnContainer}>
          <Button title="Show Picker" color="purple" onPress={showPicker1} />
        </View>
      )}
...
<CustomInput
   placeholder="Previous company1"
   value={Previouscompany1}
   setValue={setPreviouscompany1} />
...
<CustomInput
   placeholder="Previous company2"
   value={Previouscompany2}
   setValue={setPreviouscompany2} />
